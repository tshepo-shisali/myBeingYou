...
mixin _$UserStore on UserStoreBase, Store {
  ...
  dynamic setUserAddressAndLocation(String address) {
   ...
   @override
  dynamic setPeerId(String peerId) {
    final _$actionInfo = _$UserStoreBaseActionController.startAction(
        name: 'UserStoreBase.setPeerId');
    try {
   ...
   @override
  dynamic setPeerName(String peerName) {
    final _$actionInfo = _$UserStoreBaseActionController.startAction(
        name: 'UserStoreBase.setPeerName');
    try {
      return super.setPeerName(peerName);
    } finally {
      _$UserStoreBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  dynamic setUserLookingForJob(bool isLookingForJob) {
   ...
   @override
  dynamic setStudentOrTherapist(bool isStudentOrTherapist) {
    final _$actionInfo = _$UserStoreBaseActionController.startAction(
        name: 'UserStoreBase.isStudentOrTherapist');
    try {
      return super.setStudentOrTherapist(isStudentOrTherapist);
    } finally {
      _$UserStoreBaseActionController.endAction(_$actionInfo);
    }
  }
