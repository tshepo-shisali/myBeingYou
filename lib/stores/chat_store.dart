...
abstract class ChatStoreBase with Store {
  ...
  @observable
  bool isLookingForJob = true;
  @observable
  bool isStudent = true; // Just a random ID
  ...
  @action
  void setUserNameAndHeadline(Map userData) {
    isLookingForJob = userData['isLookingForJob'];
    isStudent = userData['isStudent'];
  
  }
   void setUserStatus(Map userData) {
