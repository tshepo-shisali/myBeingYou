...
mixin _$ChatStore on ChatStoreBase, Store {
  ...
  void setPeerNameAndHeadline(Map<dynamic, dynamic> userData) {
   ...
   @override
  void setUserNameAndHeadline(Map<dynamic, dynamic> userData) {
    final _$actionInfo = _$ChatStoreBaseActionController.startAction(
        name: 'ChatStoreBase.setUserNameAndHeadline');
    try {
      return super.setUserNameAndHeadline(userData);
    } finally {
      _$ChatStoreBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  @override
  void setUserStatus(Map<dynamic, dynamic> userData) {
    final _$actionInfo = _$ChatStoreBaseActionController.startAction(
        name: 'ChatStoreBase.setUserStatus');
    try {
      return super.setUserStatus(userData);
    } finally {
      _$ChatStoreBaseActionController.endAction(_$actionInfo);
    }
  }
